<?php
/*
  $Id: builder_product_list.php, v 1.1.0 2008/12/03 01:48:08 10c $
...
define('TEXT_TITLE', 'Assemble your product using the following component options. The recommended approach is to start with the first component and then work your way down the entire list. This product builder uses a heirarchical dependency feature to limit each of the components options.');
define('TEXT_TITLE_INSTRUCTION', '<br>Please note that your Components Selections will be cleared if you refresh this page.');
...
define('TEXT_BUILD_DETAILS', 'New product details (optional)');
...
define('HEADING_BUILD_IMAGE_DESCRIPTION','default image');
