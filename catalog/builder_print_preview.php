<?php
/*
  $Id: builder_print_preview.php, v 1.1.0 2008/12/01 23:03:53 10c $
  ...
  <hr color="#000000" size="1">
    <tr>
      <td width="34%">
        ...
        <?php echo $cpb_product_builder_name . ' (' . $cpb_build_name . ')'; ?></font></b>
      </td>
      <tr>
        <td width="37%">
...
?>
        <tr>
          ...
          <td width="373"><?php if ($InsertProducts[$pcount]!="0"){echo stripslashes($InsertProducts[$pcount]);} ?></td>
          <td width="100" align="right"><?php if ($InsertProducts[$pcount]!=""){echo $currencies->format(substr($InsertPrices[$pcount], 2), false);} ?></td>
          <td width="52" align="center"><?php if ($InsertProducts[$pcount]!=""){echo $InsertQTY[$pcount];} ?></td>
        </tr>
<?php
            $pcount++;
      }
