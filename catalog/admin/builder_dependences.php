<?php
/*
  $Id: builder_dependences.php, v 1.1.0 2008/09/30 10c $
...
// PRODUCT FILTER ADJUSTMENT ACCORDING TO ADMIN RULING
  if (!$cpb_matrix_edit_show_nostock) {
    $product_filter = "p.products_quantity > 0 and ";
  }
  if (!$cpb_matrix_edit_show_disabled) {
    $product_filter = "p.products_status = '1' and ";
  }
...
while ($bcomp = tep_db_fetch_array($bcomp_query)){
  ...
  $pcdcat[$bcomp['cpb_category_id']]= $bcomp['cpb_depends_category_id'];
  $pcimg[$bcomp['cpb_category_id']]= $bcomp['cpb_category_image'];
  $osccat[$bcomp['cpb_category_id']]= $bcomp['osc_category_id'];
//echo $osccat[$bcomp['cpb_category_id']] . ',';
//echo $pcdcat[$bcomp['cpb_category_id']] . ',';
}
...
($row_by_page) ? define('MAX_DISPLAY_ROW_BY_PAGE' , $row_by_page ) : $row_by_page = $cpb_matrix_edit_default_lines_per_page; define('MAX_DISPLAY_ROW_BY_PAGE' , $cpb_matrix_edit_default_lines_per_page );
          ...
          <tr>
            <td>
              <table width="100%" cellspacing="0" cellpadding="2" border="0">
                <tr align="left">
                  <form name="update" method="POST" action="<?php echo tep_href_link( 'builder_dependences.php', 'action=update&page='. $page.'&sort_by='. $sort_by .'&cID='. $cID. '&row_by_page='. $row_by_page .'&manufacturer='. $manufacturer . '&d_manufacturer=' . $d_manufacturer); ?>">
...
?>
                        ...
                        <tr height="25">
                          <?php echo tep_draw_form('categorie',  'builder_dependences.php', '', 'get'); echo tep_draw_hidden_field( 'row_by_page', $row_by_page); echo tep_draw_hidden_field( 'manufacturer', $manufacturer); echo tep_draw_hidden_field( 'd_manufacturer', $d_manufacturer); echo tep_draw_hidden_field('cID', $cID);?>
                          <td colspan="2" class="dataTableContent" align="center"><?php echo '(' . tep_output_generated_category_path($dID_osc) . ')'; ?></td></form>
                        </tr>
                        <tr height="25">
                          <?php echo tep_draw_form('d_manufacturers',  'builder_dependences.php', '', 'get'); echo tep_draw_hidden_field( 'row_by_page', $row_by_page); echo tep_draw_hidden_field( 'cID', $cID); echo tep_draw_hidden_field( 'manufacturer', $manufacturer);?>
                  ...
                  <tr class="dataTableHeadingRow_c">
                    <td><table height="45%" width="100%" cellspacing="0" cellpadding="2" border="0">
                      ...
                      <tr height="25">
                        <?php echo tep_draw_form('builder',  'builder_dependences.php', '', 'get'); echo tep_draw_hidden_field( 'row_by_page', $row_by_page);?>
                      ...
                      <tr height="25">
                        <?php echo tep_draw_form('manufacturers',  'builder_dependences.php', '', 'get'); echo tep_draw_hidden_field( 'row_by_page', $row_by_page); echo tep_draw_hidden_field( 'cID', $cID); echo tep_draw_hidden_field( 'd_manufacturer', $d_manufacturer);?>
                    ...
                    <td><table height="10%" width="100%" cellspacing="0" cellpadding="2" border="0">
                      <tr class="dataTableContent">
                        <td align="right">
                          ...
                          <?php echo TABLE_HEADING_MODEL . " <a href=\"" . tep_href_link(  'builder_dependences.php', 'cID='. $cID .'&sort_by=p.products_model ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer . '&d_manufacturer=' . $d_manufacturer)."\" >".tep_image('images/icon_up.gif', TEXT_SORT_ALL . TABLE_HEADING_MODEL . ' ' . TEXT_ASCENDINGLY)."</a>
                          <a href=\"" . tep_href_link(  'builder_dependences.php', 'cID='. $cID .'&sort_by=p.products_model DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer . '&d_manufacturer=' . $d_manufacturer)."\" >".tep_image('images/icon_down.gif', TEXT_SORT_ALL . TABLE_HEADING_MODEL . ' ' . TEXT_DESCENDINGLY)."</a>";?>
                          <?php echo '&nbsp;' . TABLE_HEADING_PRODUCTS . " <a href=\"" . tep_href_link(  'builder_dependences.php', 'cID='. $cID .'&sort_by=pd.products_name ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer . '&d_manufacturer=' . $d_manufacturer)."\" >".tep_image('images/icon_up.gif', TEXT_SORT_ALL . TABLE_HEADING_PRODUCTS . ' ' . TEXT_ASCENDINGLY)."</a>
                          <a href=\"" . tep_href_link(  'builder_dependences.php', 'cID='. $cID .'&sort_by=pd.products_name DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer . '&d_manufacturer=' . $d_manufacturer)."\" >".tep_image('images/icon_down.gif', TEXT_SORT_ALL . TABLE_HEADING_PRODUCTS . ' ' . TEXT_DESCENDINGLY)."</a>";?>
                          <?php echo '&nbsp;';?>
                        </td>
                      </tr>
                    </table></td>
...
if ($cID_osc == 0) {
  $where_str = $product_filter . "p.products_id = pd.products_id and pd.language_id = '$languages_id' and p.products_id = pc.products_id and c.categories_id = pc.categories_id and (";
  $first_time = 1;
...
// categories that have multiple dependents will clutter the query - this check makes sure it only features once
  ...
  $where_str = $product_filter . "p.products_id = pd.products_id and pd.language_id = '$languages_id' and p.products_id = pc.products_id and c.categories_id = pc.categories_id and (pc.categories_id = '" . $dID_osc . "'";
  if (tep_childs_in_category_count($dID_osc)) {
    $subcategories_array = array();
    tep_get_subcategories($subcategories_array, $dID_osc);
    for ($i=0, $n=sizeof($subcategories_array); $i<$n; $i++ ) {
...
// dont show builder categories that have no dependence
  ...
  $where_str = $product_filter . "p.products_id = pd.products_id and pd.language_id = '$languages_id' and p.products_id = pc.products_id and c.categories_id = pc.categories_id and (pc.categories_id = '" . $cID_osc . "'";
  if (tep_childs_in_category_count($cID_osc)) {
    $subcategories_array = array();
    tep_get_subcategories($subcategories_array, $cID_osc);
    for ($i=0, $n=sizeof($subcategories_array); $i<$n; $i++ ) {
...
// ONLY SHOW PRODUCTS THAT CAN BE CHANGED
//  if ($_products['categories_id'] == $_d_products['categories_id']) {
//      $blank_list_of_products_ids[$_products['products_id']] = 1;
//  }
...
// ONLY DRAW A CHECKBOX IF IT IS A VALID DEPENDENCY CANDIDATE
//    echo $products[$product_focus]['categories_id'];
//    echo $d_products[$product_focus_2]['categories_id'];
if ($products[$product_focus]['categories_id'] != $d_products[$product_focus_2]['categories_id']) {

          echo tep_draw_checkbox_field('matrix[' . $product_focus . '][' . $product_focus_2 . ']' , 0, $matrix[$product_focus][$product_focus_2]);
}
        } else {
 //         echo tep_image('images/icon_status_red.gif', TEXT_IMAGE_DENIED);
        }
                      echo "</td>\n";
      }
                      echo "<td class=\"dataTableHeadingRow\" width=\"20\" align=\"center\"><?php echo '&nbsp;';?></td>\n";
                      echo "<td class=\"dataTableHeadingRow_c\" width=\"20\" valign=\"center\" align=\"center\"><a href=\"". tep_href_link ('categories.php', 'pID='. $products[$product_focus]['products_id'] .'&cPath='. $products[$product_focus]['categories_id'] .'&action=new_product')."\">". tep_image('images/icon_arrow_right_blue.gif', TEXT_IMAGE_SWITCH_EDIT) ."</a></td>\n";
  }
            ...
            <td>
              <table width="100%" cellspacing="0" cellpadding="2" border="0">
                <tr>
                  ...
                  <td class="dataTableWarning" align="center">
<?php
if ((!$cpb_matrix_edit_show_nostock) && (!$cpb_matrix_edit_show_disabled)) {
  echo TEXT_NOSTOCK_EXCLUDED . '<br>' . TEXT_DISABLED_EXCLUDED;
} elseif (!$cpb_matrix_edit_show_nostock) {
  echo TEXT_NOSTOCK_EXCLUDED;
} elseif (!$cpb_matrix_edit_show_disabled) {
  echo TEXT_DISABLED_EXCLUDED;
}
?>
                  </td>
                </tr>
                  ...
                  <tr class="dataTableContent">
                    <td height="30" class="dataTableHeadingContent" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr class="dataTableContent">
                        ...
                        <td class="dataTableContent" align="right"><?php echo tep_draw_form('row_by_page',  'builder_dependences.php', '', 'get'); echo tep_draw_hidden_field( 'manufacturer', $manufacturer); echo tep_draw_hidden_field( 'd_manufacturer', $d_manufacturer); echo tep_draw_hidden_field( 'cID', $cID); echo tep_draw_hidden_field('dID',$dID);?></td>
